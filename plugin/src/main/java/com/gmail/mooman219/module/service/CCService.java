...
import com.gmail.mooman219.module.service.command.SetRank;
...
public class CCService extends CowModule {
    ...
    public class Formats {
        ...
        public final Bulletin WIPEERROR = new Bulletin(Chat.msgError, "\"{0}\" does not exist.", Chat.formatError);
    }
}
