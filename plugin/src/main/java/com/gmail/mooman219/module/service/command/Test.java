...
public class Test extends CCommand {
    ...
    public void processPlayer(Player sender, CDPlayer playerData, String[] args) {
        ...
        if(flag == 0) {
            ...
            int donorlevel = NumberHelper.toInt(args[1]);
            int stafflevel = NumberHelper.toInt(args[2]);
            playerData.setRank(donorlevel, stafflevel);
            Loader.info("set rank to " + donorlevel + " " + stafflevel);
        }
    }
}
